...
export default function App() {
  ...
  const handleGreet = () => {
    Alert.alert('Pronto!', `Seja bem-vindo(a), ${name || 'usuário'}!`);
  };
  ...
  const simulateLoading = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      Alert.alert('Pronto!', 'A roupa foi concluída.');
    }, 2000);
  };

  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Estoque de loja</Text>

      <Image
        source={require('./assets/logoLoja.png')}
        style={styles.image}
        resizeMode='contain'
        />
      ...
      <Button title="Salvar" onPress={handleGreet} />
